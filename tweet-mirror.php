 ...
 */
$GLOBALS['tweet_mirror'] = new tweet_mirror;
...
class tweet_mirror {
	 ...
	 * @var string
	 */
	protected $prefix = 'tweet_mirror_';
	 ...
	 *
	 * @see tweet_mirror::set_options()  to obtain the saved
	 *      settings
	 * @var array
	 */
	...
	public function __construct() {
		...
		if (is_admin()) {
			...
			$admin = new tweet_mirror_admin;

			if (is_multisite()) {
				$admin_menu = 'network_admin_menu';
				$admin_notices = 'network_admin_notices';
				$plugin_action_links = 'network_admin_plugin_action_links_tweet-mirror/tweet-mirror.php';
			} else {
				$admin_menu = 'admin_menu';
				$admin_notices = 'admin_notices';
				$plugin_action_links = 'plugin_action_links_tweet-mirror/tweet-mirror.php';
			}
	 ...
	 * @return void
	 *
	 * @uses tweet_mirror::set_options()  to replace the default
